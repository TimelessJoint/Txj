...
function renderProducts(list=products){
 ...
 <div class="product-meta"><div><div class="product-name">${p.name}</div><div class="product-type">${p.type}</div></div><div class="product-price">$${p.price}</div><div class="product-sizes" aria-label="Available sizes">S · M · L · XL · XXL · XXXL</div></div>
 </article>`).join("");
}
renderProducts();
